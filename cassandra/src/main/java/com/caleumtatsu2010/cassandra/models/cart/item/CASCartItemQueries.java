...
public class CASCartItemQueries {
	...
	public static String insertById = "INSERT INTO techmate.cart_item (id, cart_id, product_id, num) VALUES (?, ?, ?, ?)";
	
	public static String updateById = "UPDATE techmate.cart_item SET cart_id = ?, product_id = ?, num = ? WHERE id = ? IF EXISTS;";
